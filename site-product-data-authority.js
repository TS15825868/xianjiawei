...
(function(){
  ...
  function normalizeData(data){
    ...
    data.products=data.products.map(product=>{
      ...
      if(product.id==='guilu-drink-30'){
        ...
        normalized.usage=['每日1～2罐','可直接飲用或隔水溫熱後飲用','飲用時間可依個人使用習慣與作息安排','避免冰飲','開罐後請儘速飲用完畢'];
      }
      if(product.id==='guilu-drink-180'){
        normalized.size='180cc／包（鋁袋）';
        normalized.usage=['飲用份量與時間可依個人使用習慣與作息安排','可直接飲用或隔水溫熱後飲用','飲用時間可依個人使用習慣與作息安排','避免冰飲','開封後請儘速飲用完畢'];
      }
      if(product.id==='guilu-gao'){
        normalized.size='100g／罐';
        normalized.usage=['食用時間與份量可依個人使用習慣與作息安排','初次可先從半匙開始','可直接取用或加入約100～300mL溫熱水化開','食用時間與份量可依個人使用習慣與作息安排'];
  ...
  const COPY_REPLACEMENTS=Object.freeze([
    ...
    ['食用時間與份量可依個人使用習慣與作息安排','食用時間與份量可依個人使用習慣與作息安排'],
    ['一般食用時間與份量可依個人使用習慣與作息安排','食用時間與份量可依個人使用習慣與作息安排']
  ]);
