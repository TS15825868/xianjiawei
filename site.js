...
(function () {
  ...
  const SAFE_DATA = Object.freeze({
    ...
    products: [
      ...
      {id:"guilu-tangkuai",series:"仙加味・龜鹿",name:"龜鹿湯塊",displayName:"龜鹿湯塊",size:"75g （2兩）／盒｜8塊裝",image:`images/customer-display-v20260812/guilu-tangkuai.avif?v=${VERSION}`,description:"75g／盒、8塊裝，每塊約9.375g，可搭配熱水、保溫壺或家常燉湯。",ingredients:["龜板萃取物","鹿角萃取物"],usage:["取1塊加入約300～500mL熱水","可搭配保溫壺或家常燉湯"],storage:["依實際包裝標示保存"],purpose:"沖泡與燉湯",fit:"希望搭配熱飲或料理的人",page:"product-guilu-tangkuai.html",detailPage:"product-guilu-tangkuai.html"},
