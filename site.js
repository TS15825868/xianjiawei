...
(function () {
  ...
  const SAFE_DATA = Object.freeze({
    ...
    lineId: "@762jybnm",
    products: [
      {id:"guilu-drink-30",series:"仙加味・龜鹿",name:"龜鹿飲30cc玻璃罐",displayName:"龜鹿飲30cc玻璃罐",size:"30cc／罐（小玻璃罐）",image:`images/customer-display-v20260812/guilu-drink-30cc.avif?v=${VERSION}`,description:"30cc小玻璃罐，裸罐、無貼紙，適合希望準備步驟少或外出攜帶的人。",ingredients:["水","龜板萃取物","鹿角萃取物","粉光蔘","枸杞","紅棗","黃耆"],usage:["每日1～2罐","可隔水加熱或溫熱飲用","飲用時間可依個人使用習慣與作息安排","避免冰飲"],storage:["未開封置於陰涼乾燥處","開罐後請儘速飲用完畢"],purpose:"輕巧即飲",fit:"希望方便即飲或外出攜帶的人",page:"product-guilu-drink-30cc.html",detailPage:"product-guilu-drink-30cc.html"},
      {id:"guilu-drink-180",series:"仙加味・龜鹿",name:"龜鹿飲180cc鋁袋",displayName:"龜鹿飲180cc鋁袋",size:"180cc／包（鋁袋）",image:`images/customer-display-v20260812/guilu-drink-180cc-product.jpg?v=${VERSION}`,description:"180cc鋁袋即飲型態，維持正式狹長鋁袋比例。",ingredients:["水","龜板萃取物","鹿角萃取物","粉光蔘","枸杞","紅棗","黃耆"],usage:["每日1包","可隔水加熱或溫熱飲用","飲用時間可依個人使用習慣與作息安排","避免冰飲"],storage:["未開封置於陰涼乾燥處","開封後請儘速飲用完畢"],purpose:"完整份量即飲",fit:"偏好180cc份量或居家安排的人",page:"product-guilu-drink-180cc.html",detailPage:"product-guilu-drink-180cc.html"},
      {id:"guilu-gao",series:"仙加味・龜鹿",name:"龜鹿膏",displayName:"龜鹿膏",size:"100g／罐",image:`images/customer-display-v20260812/guilu-gao.avif?v=${VERSION}`,description:"100g罐裝膏狀型態，可直接取用或以溫熱水化開。",ingredients:["鹿角萃取物","龜板萃取物","枸杞","紅棗","黃耆","粉光蔘"],usage:["食用時間與份量可依個人使用習慣與作息安排","初次可先從半匙開始","可直接食用或加入約100～300mL溫熱水化開","食用時間與份量可依個人使用習慣與作息安排"],storage:["未開封置於陰涼乾燥處","開罐後密封冷藏"],purpose:"固定日常安排",fit:"習慣固定時段取用的人",page:"product-guilu-gao.html",detailPage:"product-guilu-gao.html"},
