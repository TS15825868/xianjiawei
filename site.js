...
(() => {
  ...
  const CORE_SCENES = {"home": ["home-brand.png", "仙加味小老闆首頁品牌主視覺"], "products": ["products-all.png", "仙加味龜鹿系列全系列比較"], "choose": ["choose.jpg", "怎麼選：依使用方式選擇產品型態"], "combo": ["combo.png", "仙加味套餐搭配與料理組合"], "guide": ["guide-how-to-use.png", "仙加味產品怎麼使用"], "recipes": ["recipes.png", "仙加味料理搭配"], "brand": ["brand-story.png", "仙加味品牌故事"], "faq": ["faq.png", "仙加味常見問題"], "contact": ["contact-line.png", "聯絡仙加味與加入官方 LINE"]};
  const PRODUCT_SCENES = {"product-guilu-gao.html": ["product-guilu-gao-100g.png", "龜鹿膏100g小老闆產品情境"], "product-guilu-drink-30cc.html": ["product-guilu-drink-30cc.png", "龜鹿飲30cc小老闆產品情境"], "product-guilu-drink-180cc.html": ["product-guilu-drink-180cc.png", "龜鹿飲180cc鋁袋小老闆產品情境"], "product-guilu-tangkuai.html": ["product-guilu-tangkuai-75g.png", "龜鹿湯塊75g小老闆產品情境"], "product-guilu-jiao.html": ["product-guilu-jiao-600g.png", "龜鹿膠600g小老闆產品情境"], "product-luerong-fen.html": ["product-luerong-fen-75g.png", "鹿茸粉75g小老闆產品情境"]};
