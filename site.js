...
(function () {
  ...
  const VERSION = "20260924-premium-visual-v13";
  ...
  const SAFE_DATA = Object.freeze({
    ...
    products: [
      ...
      {id:"guilu-gao",series:"仙加味・龜鹿",name:"龜鹿膏",displayName:"龜鹿膏",size:"100g／罐",image:`images/customer-display-v20260812/guilu-gao.avif?v=${VERSION}`,description:"100g罐裝膏狀型態，可直接取用或以溫熱水化開。",ingredients:["鹿角萃取物","龜板萃取物","枸杞","紅棗","黃耆","粉光蔘"],usage:[CURRENT_GAO_TIMING,"初次可先從半匙開始","可直接食用或加入約100～300mL溫熱水化開"],usagePrimary:CURRENT_GAO_TIMING,storage:["未開封置於陰涼乾燥處","開罐後密封冷藏"],purpose:"日常安排",fit:"想依自己的生活節奏安排取用的人",page:"product-guilu-gao.html",detailPage:"product-guilu-gao.html"},
