...
/* 仙加味顧客DM權威層｜2026-08-12 small-boss-trial-v1
 * 產品圖與DM分開：產品頁／產品卡使用六張正式產品圖；DM欄位只使用各產品詳細DM。
 * 試喝圖另為獨立角色，固定使用使用者最新指定的小老闆主圖。
...
(function(){
  ...
  window.fetch=async function(input,init){
    ...
    try{
      ...
      data.runtime={...(data.runtime||{}),dmSource:'separate-corrected-detailed-dm-valid-binary',dmVersion:VERSION,trialImage:`${TRIAL}?v=${VERSION}`,trialSource:'user-provided-small-boss-trial-master-20260812',dmRoleRule:'product image / detailed DM / trial image are separate media roles'};
