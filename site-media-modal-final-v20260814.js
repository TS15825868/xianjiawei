...
(()=>{
  ...
  function fallbackToPage(element){
    ...
    if(!href)return;
    try{window.location.assign(new URL(href,location.href).href);}catch(_){window.location.href=href;}
  }
  ...
  function enforce(){fixDm();fixTrial();normalizeIntroActions();document.documentElement.dataset.productIntroMode='modal-v20260814-v4';}
  let queued=false;
