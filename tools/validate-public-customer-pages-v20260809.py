...
def main():
 ...
 # 一般產品頁／首頁不公開全系列售價；正式試喝頁是使用者核准活動例外。
 ...
 req('guilu-drink-trial.webp' in trial_source,'trial.html 必須使用目前核准正式試喝圖')
 ...
 for phrase in ['龜鹿飲試喝組','3罐','試喝品免費','運費自付','7-11 店到店','60元','郵局宅配','100元','30cc／罐（小玻璃罐）','180cc／包（鋁袋）','買10送1','11罐 600元','11包 2,000元']:
  req(phrase in trial,f'trial.html 缺少使用者核准正式試喝資訊：{phrase}')
 ...
 print(f'PASS public customer pages: {len(PUBLIC_PAGES)} pages follow current specs; technical/internal copy hidden; general catalog prices hidden; user-approved trial may show its current prices/shipping; no legacy spec/copy lock.')
