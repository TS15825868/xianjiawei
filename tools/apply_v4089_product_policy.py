...
EXACT_REPLACEMENTS = {
    ...
    "適合希望在早上或下午建立固定食補安排的人": "適合希望在早上或空腹前後建立固定食補安排，並避免睡前食用的人",
    "龜鹿膏可依個人習慣安排於早上或下午，並選擇固定、方便持續的時段。": "龜鹿膏可安排於早上或空腹前後，並避免睡前食用；可選擇固定、方便持續的時段。",
    "龜鹿膏加入約100～300mL熱水化開後，調至適合溫度再飲用。": "龜鹿膏可加入適量熱水化開，調至適合溫度後飲用。",
    "可以，也可加入約100～300mL熱水化開，調至適合溫度後飲用。": "可以，也可加入適量熱水化開，調至適合溫度後飲用。",
    "龜鹿飲有30cc玻璃瓶與180cc鋁袋兩種規格，皆屬即飲型態；也可依個人習慣溫熱後飲用。": "龜鹿飲30cc每日一瓶、180cc每日一包；可開封即飲，也可隔水加熱或溫熱後飲用，避免冰飲。",
