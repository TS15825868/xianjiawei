(()=>{
  const BASE_RULES=`品牌只顯示「仙加味」，不可出現台興山產有限公司、統編、公司電話或公司地址。文案以日常飲食、生活節奏、料理搭配為主，不談療效、不強迫推銷。固定標語可使用「補養，是一種節奏。」。產品規格必須正確；龜鹿飲30cc為小玻璃裸罐、金色蓋、無貼紙、無外盒、無外袋；龜鹿飲180cc為狹長直立鋁袋，寬高比約0.64；龜鹿膏100g只使用目前新版米白標籤，舊紅白直式貼紙禁止；龜鹿膠600g淡紫盒不可橫向拉長。小老闆固定官網Q版造型，小老闆出現時小鹿與小烏龜必須同時出現；河馬娃娃與小鹿安撫巾只在適合的居家陪伴情境使用。季節、天氣、場合、地點、情境、環境、冷熱、表情、動作必須互相一致。`;
