(()=>{
  ...
  const PRODUCTS=[
    ...
    {id:'guilu-jiao',short:'龜鹿膠600g',name:'龜鹿膠',spec:'600g （1斤）／盒｜32塊裝｜每塊約18.75 g',mode:'家庭料理',image:'images/products-v3/guilu-jiao.jpg',visual:'淡紫色正式盒裝，32塊裝，等比例呈現，不與龜鹿湯塊混用。'},
  ...
  const FAQ=[
    ...
    ['龜鹿膠規格','龜鹿膠為600g（1斤）／盒，32塊裝，每塊約18.75 g，使用淡紫正式盒裝。'],
