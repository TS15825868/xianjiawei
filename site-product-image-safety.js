 ...
 * 修正：圖片修正必須 idempotent；HTML 導覽連結永遠不得被圖片守門員改寫。
 */
(function(){
  ...
  function start(){repair(document);const observer=new MutationObserver(queueRepair);observer.observe(document.documentElement,{childList:true,subtree:true,attributes:true,attributeFilter:['src','href','srcset']});}
